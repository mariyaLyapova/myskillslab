package com.myskillslab.controller;

import com.myskillslab.entity.Question;
import com.myskillslab.repository.QuestionRepository;
import com.myskillslab.service.BigQueryQuestionService;
...
public class SkillsController {
    ...
    // Get all questions for the skills assessment
    @GetMapping("/api/skills/questions")
    @ResponseBody
    ...
    @GetMapping("/api/skills/random/{count}")
    @ResponseBody
