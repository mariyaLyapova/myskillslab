package com.myskillslab.config;

import com.myskillslab.service.JsonImportService;
...
public class DatabaseInitializer implements ApplicationRunner {
    ...
    @Value("${myskillslab.auto-initialize:true}")
    private boolean autoInitialize;

    @Value("${myskillslab.json-file-path:file:input/myskillslab-questions.json}")
    private String jsonFilePath;

    @Value("${myskillslab.clear-on-startup:true}")
    ...
    public void run(ApplicationArguments args) throws Exception {
        ...
        try {
            ...
            File dbFile = new File("db/myskillslab.db");
