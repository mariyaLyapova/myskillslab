package com.myskillslab.service;
 ...
 * Converts the MySkillsLab JSON format to Question entities
 */
@Service
public class JsonImportService {
    ...
    /**
     * Import from default location (input/myskillslab-questions.json)
     */
    public int importDefaultQuestions() {
        return importQuestionsFromJson("file:input/myskillslab-questions.json");
    }
